...
public class CylinderCollisionHull3D : CollisionHull3D
{
    // Constructor.
    public CylinderCollisionHull3D() : base(CollisionHullType3D.hull_cylinder) { }
    ...
    [SerializeField]
    private Vector2 heightAxis = Vector2.zero;
...
public class CyclinderEditor3D : Editor
{
    private void OnSceneGUI()
    {
        // Get the circle hull attached to this script.
        CylinderCollisionHull3D circleHull = (CylinderCollisionHull3D)target;
